    ...
    >
      ...
      >
          ...
          >
            ...
            >
              <a
                ...
                className={`nav-link ${
                  isDarkMode
                    ? "text-light hover:text-action"
                    : "text-dark hover:text-action"
                } transition-colors`}
        ...
        <main>
          <section
            id="accueil"
            className="section pt-32 bg-hex-pattern"
            ...
            <div className="container">
              ...
              >
                ...
                >
                  ...
                  , méthodique et analytique, je transforme des concepts
                  complexes en{" "}
                  <span className="text-primary font-semibold">
                    solutions élégantes
                  </span>
            ...
            <div className="container">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-dark/90 dark:text-light/90">
                    Une approche méthodique et structurée qui assure des
                    livrables de qualité dans les délais impartis. Votre
            ...
            <div className="container">
              ...
              <div className="max-w-3xl mx-auto">
                ...
                >
                  ...
                  >
                    En tant que développeur junior passionné, je suis
                    actuellement disponible pour des projets freelance. Mon
                    engagement est total pour chaque projet, avec une approche
                    méthodique héritée de mon parcours en comptabilité.
                  </p>
                    ...
                    >
                      <div>
                        ...
                        <motion.input
                          ...
                          id="name"
                          name="name"
                          className={`w-full px-4 py-2 rounded border input-focus ${
                            isDarkMode
                              ? "bg-dark border-light/10 text-light"
